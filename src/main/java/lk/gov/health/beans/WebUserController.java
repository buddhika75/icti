...
public class WebUserController implements Serializable {
    ...
    public void fillLogginDetails() {
        if (developmentStage) {
            ...
            mySchools = institutionController.getInstitutions(InstitutionType.Instituon, null, null, null);
            return;
        }
        switch (loggedUser.getType()) {
            case SPHNS:
            ...
            case MOH_Staff:
                ...
                mySchools = institutionController.getInstitutions(InstitutionType.Instituon, null, loggedRdhsArea, null);
                break;
            case MO_RDHS:
            case CCP_RDHS:
            case RDHS_Staff:
            ...
            case PDHS:
                ...
                mySchools = institutionController.getInstitutions(InstitutionType.Instituon, null, loggedPdhsArea, null);
                break;
            case Institution_Administrator:
            case Institution_Super_User:
            case System_Administrator:
