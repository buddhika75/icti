...
public class ItemController implements Serializable {
    ...
    @EJB private lk.gov.health.faces.ItemFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleItem").getString("ItemCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleItem").getString("ItemUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleItem").getString("ItemDeleted"));
        if (!JsfUtil.isValidationFailed()) {
